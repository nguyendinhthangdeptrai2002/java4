...
<main class="mt-3 container-fluid">
    ...
    <form action="share-user" class="">
        <label for="video" class="form-label mx-2 my-1">Video Title</label>
        <input name="title" class="form-control" list="videoList" id="video" placeholder="Type to search...">
        ...
        <table class="table table-hover table-striped ">
            ...
            <c:forEach items="${shareList}" var="share">
                <tr>
                    ...
                    <jsp:setProperty name="date" property="time" value="${share.shareDate}"/>
