...
<div class="col-sm-6 col-md-3 col-4">
    <div class="card border border-1">
        ...
        <div class="card-body">
                ...
                <div class="pt-1 d-flex justify-content-between">
                    <div class="form-check align-self-center">
                        <input class="form-check-input" type="checkbox" id="remember"
                               name="remember" value="true" checked>
                        <label class="form-check-label" for="remember" style="color:#EF7127">Remember me</label>
                    </div>
                    <a href="/asm_java4/forgot-password" class="text-decoration-none " id="forgot-password">Forgot password?</a>
                </div>
            ...
            <div class=" py-2 mt-3 text-center text-muted">Don't have an account? <a href="/asm_java4/signup">Cick here</a></div>
